...
const { absoluteOwnerHomePath } = await import(
...
const syntheticHomeFixtures = [
  ['test/model-routing-adapter-claude.test.mjs', homePath('/', 'home', '/', 'someone')],
...
check('publicity audit exempts only named synthetic home fixtures',
