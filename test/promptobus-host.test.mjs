...
check('bus hook uses the host regeneration command, not a baked subcommand',
  hookA.includes('Generated by alpha install') && hookB.includes('Generated by beta install'),
  hookA.split('\n')[1]);
...
check('hook plan writes the standalone bus-hook path',
  ...
  && planned.text.includes('Generated by alpha install'),
  planned.rel);
