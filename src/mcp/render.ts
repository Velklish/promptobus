...
// (ADR-032, §2 — Git, worktree и harness за границу package не заходят).
...
// Метка машинного адреса в ответах шины. По ней хук ленты (`cli/lib/bushook.js`) отделяет
...
// (`sessionName` в spawn.js). Форма проверяется целиком: заголовок со скобкой уцелеет.
