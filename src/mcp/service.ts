...
//
// Service передаётся factory ЯВНО (ADR-032, §3: registry передаётся в core аргументом, а не
// берётся из воздуха), и **дефолтной реализации у него нет**: половина перечня — дело
...
// окружение читает только adapter (ADR-032, §2). Собирает service он же —
// [cli/lib/promptobus/store.js](../../../../lib/promptobus/store.js).
//
