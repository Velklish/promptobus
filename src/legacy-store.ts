...
// Who still reads it and why it is kept: [reference/01-overview.md#seq--bus-store-v0610--a-maildir-store-of-a-task](../docs/reference/01-overview.md#seq--bus-store-v0610--a-maildir-store-of-a-task)
