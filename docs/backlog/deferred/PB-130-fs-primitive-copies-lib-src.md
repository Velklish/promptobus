...
- **Deferred:** 2026-09-07
- **Reason:** Publishing internal filesystem primitives changes the package API and overlaps store and registry fixes.
- **Return condition:** Store and registry fixes are accepted and a specific internal reuse boundary is designed without automatically widening the public API.

## Triage — 2026-09-07

- **Track:** X — Deferred structural work.
- **Priority:** P3.
- **Evidence level:** source/definition review at `1e0401a`, including `src/index.ts:7`, `src/fs/atomic.ts:3`. Historical live measurements were not repeated; a regression reproducer is still required before a runtime fix is accepted.
