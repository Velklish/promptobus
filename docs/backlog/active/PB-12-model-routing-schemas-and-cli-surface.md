...
- Contract quotes in `--help` where the existing suite pins help text — deferred to PB-21 (orchestrator, 2026-09-05): live help must not advertise a command that answers "unknown command"; this task pins the help contract as a pending check that PB-21 turns green.
