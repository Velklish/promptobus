...
- **Priority:** P1.
- **Evidence level:** source/definition review at `1e0401a`, including `scripts/live-mixed.mjs:218`, `lib/store.js:873`. Historical live measurements were not repeated; a regression reproducer is still required before a runtime fix is accepted.
