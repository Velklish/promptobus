...
- **Priority:** P1.
- **Evidence level:** source/definition review at `1e0401a`, including `src/supervisor.ts:623`, `src/sidecar.ts:162`. Historical live measurements were not repeated; a regression reproducer is still required before a runtime fix is accepted.
