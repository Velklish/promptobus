...
- **Priority:** P1.
- **Evidence level:** source/definition review at `1e0401a`, including `test/sandbox.mjs:187`, `scripts/live-e2e.mjs:41`. Historical live measurements were not repeated; a regression reproducer is still required before a runtime fix is accepted.
