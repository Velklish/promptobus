...
- The `faults` seam of `listArtifacts` — [PB-146.3](../../backlog/minor/PB-146.3-list-artifacts-without-faults-seam.md), which returns when this card touches `src/v1/artifacts.ts`.
