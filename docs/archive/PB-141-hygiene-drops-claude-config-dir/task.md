...
- **Priority:** P1.
- **Evidence level:** source/definition review at `1e0401a`, including `test/hygiene.mjs:277`, `test/run.mjs:130`. Historical live measurements were not repeated; a regression reproducer is still required before a runtime fix is accepted.
