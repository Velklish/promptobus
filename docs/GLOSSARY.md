...
| strategy | strategy | Named priority of quality, speed and subscription spend a routed run is picked by: `quality`, `balanced`, `speed`, `economy`. `auto` is a skill decision, never a CLI value. | `lib/model-routing/catalog.js` (`STRATEGIES`) |
