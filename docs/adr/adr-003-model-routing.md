...
Reason codes: `binary_missing`, `not_authenticated`, `model_not_available`, `subscription_exhausted`, `probe_timeout`, `probe_failed`, `quota_unknown`, `stale_cache`, `manual_exhaustion`.
