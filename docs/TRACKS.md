...
Added after this snapshot (triage of 2026-09-10, findings of this track's own run): [PB-146.1](archive/PB-146.1-direct-reads-flatten-errno-to-not-found/task.md), [PB-65.1](archive/PB-65.1-fanout-mkdir-refusal-escapes-classification/task.md), [PB-63.1](archive/PB-63.1-migration-needed-true-on-sweep-only-plan/task.md), [PB-146.2](archive/PB-146.2-recover-history-discard-broken-tasks/task.md), [PB-66.1](backlog/queue/PB-66.1-inbox-unreadable-ref-knock-loop-unbounded.md), in that order.
