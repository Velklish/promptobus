...
This document records triage decisions and execution boundaries, not a second status board. Status is the task directory; priority is its `Order` field. Use `npx github:Velklish/backslop#v0.8.0 status` for the current queue. Track assignments below are a planning snapshot and do not imply a running worker.
...
Added after this snapshot (triage of 2026-09-10, findings of this track's own run): [PB-146.1](archive/PB-146.1-direct-reads-flatten-errno-to-not-found/task.md), [PB-65.1](archive/PB-65.1-fanout-mkdir-refusal-escapes-classification/task.md), [PB-63.1](archive/PB-63.1-migration-needed-true-on-sweep-only-plan/task.md), [PB-146.2](archive/PB-146.2-recover-history-discard-broken-tasks/task.md), [PB-66.1](archive/PB-66.1-inbox-unreadable-ref-knock-loop-unbounded/task.md), in that order.
...
Added after this snapshot (triage of 2026-09-10): [PB-88.2](archive/PB-88.2-measure-app-server-approval-params-shape/task.md) — the approval params measured from the generated app-server schema of codex-cli 0.146.0 — then [PB-88.1](archive/PB-88.1-worker-permissions-request-bypasses-containment/task.md); [PB-116](archive/PB-116-codex-initialize-handshake-duplicated/task.md) moves here from R and follows them, because all three edit `lib/codex-session.js`.
...
Queued assignments: [PB-87](archive/PB-87-reviewer-mcp-write-isolation/task.md), [PB-126](archive/PB-126-review-git-spawn-no-timeout/task.md), [PB-83](archive/PB-83-spawn-preamble-missing-deps-line/task.md), [PB-44](archive/PB-44-rules-list-dry-run-only/task.md), [PB-51](archive/PB-51-standalone-plugin-warning-wrong/task.md), [PB-54](archive/PB-54-review-refusals-plain-error/task.md), [PB-55](archive/PB-55-bus-hint-wraps-wrong-command/task.md), [PB-80](archive/PB-80-cli-catch-instanceof-not-name/task.md), [PB-96](archive/PB-96-reviewer-worktree-pickup-fallback/task.md), [PB-140](archive/PB-140-refusal-messages-hardcode-bare-command/task.md).
...
Deferred assignments: [PB-81](backlog/active/PB-81-cursor-stdout-guard-and-dedupe.md), [PB-95](archive/PB-95-mutation-probe-has-no-script/task.md), [PB-117](archive/PB-117-registry-and-driver-duplication/task.md), [PB-118](backlog/active/PB-118-done-triple-listtasks-walk.md), [PB-127](backlog/active/PB-127-dead-file-citations-in-comments.md), [PB-129](archive/PB-129-duplicate-worktree-spawn-failure-classification/task.md), [PB-130](archive/PB-130-fs-primitive-copies-lib-src/task.md), [PB-133](archive/PB-133-store-path-names-scattered/task.md), [PB-134](archive/PB-134-messages-read-loop-dedup/task.md), [PB-139](backlog/active/PB-139-tsc-lib-untyped-unused-code.md), [PB-13.2](backlog/deferred/PB-13.2-catalog-has-no-payg-row.md), [PB-16.1](backlog/deferred/PB-16.1-cursor-start-path-names-no-limit.md), [PB-24.1](backlog/deferred/PB-24.1-codex-notification-window-duration.md), [PB-24.2](backlog/deferred/PB-24.2-snapshot-model-has-no-efforts-or-speed-tiers.md).
