...
Queued assignments: [PB-63](archive/PB-63-migrate-mark-never-removed/task.md), [PB-66](archive/PB-66-recovery-misreads-errno-as-corruption/task.md), [PB-65](backlog/active/PB-65-recovery-open-failure-bricks-store.md), [PB-132](backlog/active/PB-132-task-id-grammar-two-homes.md), [PB-146](backlog/active/PB-146-unreadable-record-taxonomy-gap.md), [PB-102](backlog/active/PB-102-mixed-version-diagnosis-unreachable.md), [PB-101](backlog/active/PB-101-four-commands-bypass-host-home.md), [PB-131](backlog/active/PB-131-message-types-mutable-array.md), [PB-135](backlog/active/PB-135-sendsyncinput-not-exported.md), [PB-147](backlog/active/PB-147-prune-remove-seam-untested.md).
...
Queued assignments: [PB-45](archive/PB-45-registry-read-swallows-refusal/task.md), [PB-151](archive/PB-151-cursor-inject-buffer-file-mode/task.md), [PB-148](backlog/active/PB-148-limit-regex-alternation-order.md), [PB-153](backlog/active/PB-153-cursor-status-turn-count-wrong.md), [PB-85](backlog/active/PB-85-driver-cursor-tmux-path-only.md), [PB-93](backlog/active/PB-93-cursor-bin-name-order-mismatch.md).
