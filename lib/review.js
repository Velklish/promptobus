...
The header is at most ${RESULT_BODY_MAX} characters; the findings follow it in the same body, and they are not bounded. **You have no artifact to move them into** — file writes are disabled for you by the mechanism, and the report leaves by one channel. That is the one place where your hand-off differs from a worker's, whose overflow does go into an attached file.
