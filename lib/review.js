...
import { ok, info, warn, fail, PROC_MAX_OUTPUT } from './util.js';
...
// Output ceiling is shared with the zone walk (`PROC_MAX_OUTPUT`, util.js): on
...
function git(repoDir, args) {
  const r = spawnSync('git', ['-C', repoDir, ...GIT_OPTS, ...args], { encoding: 'utf8', maxBuffer: PROC_MAX_OUTPUT });
