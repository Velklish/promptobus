// Bus contract constants shared by the package and its drivers.
// What each one fixes: [reference/04-protocol.md#the-bus-contract-constants](../docs/reference/04-protocol.md#the-bus-contract-constants)
