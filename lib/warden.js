...
export {
  KNOCK_RETRY_SEC, ROUND_FAIL_LIMIT, SILENCE_SEC, TICK_MS, WARDEN_ABSOLUTE_SEC, WARDEN_TOTAL_SEC,
} from '../dist/index.js';
...
/** Participant stalls: fresh ones go to the journal, no postcard is sent. The addressee
 * is the task owner — there is nobody to report to the participant about. */
