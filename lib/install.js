// Project-level hook install for a consumer repository; layout comes from the host.
// User-level directories are never written: [guides/install.md#what-the-installer-knows-and-never-writes](../docs/guides/install.md#what-the-installer-knows-and-never-writes)
...
// writes it. Said here because the next command otherwise refuses ([guides/install.md#what-the-installer-knows-and-never-writes](../docs/guides/install.md#what-the-installer-knows-and-never-writes)).
