...
export const claudeDriver = {
  ...
  options: {
    ...
    // Alias → the full ids it resolves to today, handed over the same way
    ...
    // direction (promptobus-adapter.test.mjs). The same table the availability
    // adapter is handed below, and deliberately the same object: two copies
    // would go on naming different ids after a repin.
    modelAliases: MODEL_SCOPE_IDS,
