...
// prints them (`claude --help` 2.1.263, measured 2026-09-06: "an alias for the
// latest model (e.g. 'fable', 'opus', or 'sonnet')" — the same sentence 2.1.251
// printed, so the published set did not move when the `fable` alias re-pointed).
//
// The binary's baked catalog carries a fourth family, `haiku`, and a `mythos`
// family beside it; neither is in the help sentence, so neither is published
// here. This list is what the harness tells a person to type, not everything its
// table can resolve.
//
...
// for.
export const MODEL_IDS = ['claude-fable-5-1', 'claude-fable-5', 'claude-opus-5', 'claude-sonnet-5'];
