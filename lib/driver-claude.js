...
// change ([reference/10](../../../docs/reference/10-validation.md)).
...
// resolves its session from the event payload ([15](../../../docs/reference/15-warden.md))
...
// ([guardhook.js](../guardhook.js)) and the participant settings file. A READY
