...
// Environment of the lifted session: the parent's identity and messaging go, then `extra`
// is merged ON TOP — a caller that names a dropped variable wins, an ancestor never does.
