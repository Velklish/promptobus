...
// Codex harness driver: option vocabulary, command words, plan to `thread/start`.
// What lives here and what is in the session file: [reference/05-drivers.md#codex--codex-harness-driver--the-third-production-bus-driver](../docs/reference/05-drivers.md#codex--codex-harness-driver--the-third-production-bus-driver)
...
// The list: [reference/05-drivers.md#codex--codex-harness-driver--the-third-production-bus-driver](../docs/reference/05-drivers.md#codex--codex-harness-driver--the-third-production-bus-driver)
 ...
 * What a home holds and why it is swept: [reference/05-drivers.md#bindparticipanthomeremoval--remove-every-home-under-the-root-that-no-session-record-names](../docs/reference/05-drivers.md#bindparticipanthomeremoval--remove-every-home-under-the-root-that-no-session-record-names) */
 ...
 * What sitting in the reviewed clone cost (ADR-008): [reference/05-drivers.md#reviewsandbox--reviewer-working-directory-the-mechanisms-own-not-the-tree-under-review](../docs/reference/05-drivers.md#reviewsandbox--reviewer-working-directory-the-mechanisms-own-not-the-tree-under-review) */
...
// Composed, not inherited: without these two names a warden raised from a participant's
// MCP server is unstopped by the switch and unseen by the suite gate (contributing.md).
...
function prepare({
  ...
  // The self-ignoring `.gitignore` is unconditional: `.codex` in the working directory
  // now always holds at least the hooks file, and a worker's diff has no business in it.
  const files = [
