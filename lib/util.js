...
import { GIT_MAX_OUTPUT, PROC_TIMEOUT_MS, run } from './exec.js';

// Keep the established import surface for callers that take process ceilings from
// util.js; their definitions live at the launch boundary in exec.js.
export { GIT_MAX_OUTPUT, PROC_TIMEOUT_MS };
