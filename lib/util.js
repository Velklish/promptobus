// Stateless-помощники шины. Пути рабочего места сюда не входят — их отдаёт host.
...
// рядом с целью: `rename` атомарен только в пределах одной ФС, а дом шины и `/tmp` сплошь
