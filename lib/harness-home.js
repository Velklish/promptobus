// Where the package keeps its own session registry for one harness, and the refusal when
// nobody says. Resolution order, why, and the one-binding cost: [reference/02-host.md#the-harness-session-registry-and-the-refusal-when-nobody-says](../docs/reference/02-host.md#the-harness-session-registry-and-the-refusal-when-nobody-says)
