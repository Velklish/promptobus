...
//
// The execute bit is REQUIRED, not just existence, and this is the one place it
// matters: the trace is the escape gate's only evidence, and a non-executable file of
// the right name earlier on PATH is skipped by the kernel — so counting it here would
// name a path nothing ever started, and hide the directory the real binary came from
// behind it. The seal builds its symlinks by the same test
