...
function decorateParticipant(p) {
  ...
  // Which snapshot the reviewer is holding: the diff file is written once, and the age
  // of the file is the reviewer's blind spot — the orchestrator reads it here.
