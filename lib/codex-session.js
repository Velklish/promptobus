...
/**
 * A schema with nothing to fill — the second half of codex-cli's own tool-approval test
 * (`mcp_server_elicitation.rs`: `is_tool_approval && is_message_only_schema`).
 */
function messageOnlySchema(params) {
  ...
  return typeof props === 'object' && !Array.isArray(props) && Object.keys(props).length === 0;
}
