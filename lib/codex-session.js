...
export function decideApproval(method, params, record) {
  ...
  if (method === 'mcpServer/elicitation/request') {
    // One method, several questions. ONLY codex-cli's own tool approval is accepted; the
    // kind is a discriminator with more values — 03-cli § The Codex holder (PB-161.4).
    if (approvalKind(params) === MCP_TOOL_CALL_KIND) return { allow: true };
