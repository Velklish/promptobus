...
import {
  chmodSync, existsSync, mkdirSync, readdirSync, readFileSync, realpathSync, renameSync, rmSync, statSync,
  writeFileSync,
} from 'node:fs';
...
// Persist-session machinery of Cursor, one floor below the driver; nobody outside imports it.
// What `agent persist` is, the registry homes and the spike numbers: [reference/05-drivers.md#cursor-the-persist-session](../docs/reference/05-drivers.md#cursor-the-persist-session)
 ...
 * Each step and what a live miss costs: [reference/05-drivers.md#injecttext--deliver-text-into-a-live-session](../docs/reference/05-drivers.md#injecttext--deliver-text-into-a-live-session) */
 ...
 * The third liveness signal and what the first two are blind to: [reference/05-drivers.md#worktreetouchedms--how-long-ago-the-participant-last-wrote-anything-in-its-own-working-tree-in](../docs/reference/05-drivers.md#worktreetouchedms--how-long-ago-the-participant-last-wrote-anything-in-its-own-working-tree-in) */
