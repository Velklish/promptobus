// Claude Code availability adapter: two reads, no turn, no token written anywhere.
// What it reads and what was measured: [guides/model-routing.md#claude-code-adapter-what-the-probe-reads](../../docs/guides/model-routing.md#claude-code-adapter-what-the-probe-reads)
 ...
 * Why a display name and what an unmatched one means: [guides/model-routing.md#scopemodels--the-model-ids-a-scopes-display-name-resolves-to-or-null-when-it-resolves-to](../../docs/guides/model-routing.md#scopemodels--the-model-ids-a-scopes-display-name-resolves-to-or-null-when-it-resolves-to) */
...
// The tier, offline first: the credential record before any request.
// When a request happens at all: [guides/model-routing.md#usagewindows--the-usage-answer-as-adr-004-windows](../../docs/guides/model-routing.md#usagewindows--the-usage-answer-as-adr-004-windows)
...
// The limit windows and where each is read from.
// What was measured and on which build: [guides/model-routing.md#spentwindow--the-account-wide-row-that-is-spent-or-null-when-none-is](../../docs/guides/model-routing.md#spentwindow--the-account-wide-row-that-is-spent-or-null-when-none-is)
 ...
 * What `models` carries and why the driver owns it: [guides/model-routing.md#claudeavailability--the-adapter-a-driver-declares-as-availability](../../docs/guides/model-routing.md#claudeavailability--the-adapter-a-driver-declares-as-availability) */
