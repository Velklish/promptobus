// The availability cache — the first disk boundary of routing: account-scoped, mode 0600,
// projected field by field onto a closed shape. What it may hold: [guides/model-routing.md#the-availability-cache-the-first-disk-boundary-of-routing](../../docs/guides/model-routing.md#the-availability-cache-the-first-disk-boundary-of-routing)
...
// What an entry may hold — a closed shape, projected field by field.
// Why projection and not a spread: [guides/model-routing.md#scopeof--what-a-window-binds-projected-onto-the-closed-scope-shapes-or-undefined](../../docs/guides/model-routing.md#scopeof--what-a-window-binds-projected-onto-the-closed-scope-shapes-or-undefined)
...
// What a write must not carry, and what it is projected onto instead.
// The closed shape and the promise it makes: [guides/model-routing.md#snapshotentry--one-harness-entry-projected-onto-the-closed-snapshot-shape](../../docs/guides/model-routing.md#snapshotentry--one-harness-entry-projected-onto-the-closed-snapshot-shape)
...
export function writeEntries(host, entries, { at = Date.now(), dryRun = false } = {}) {
  ...
  return withCacheLock(file, () => {
    ...
    if (!Object.keys(harnesses).length) return { doc: null, dropped };
...
// Reading an entry back: what makes one stale and what a stale one still answers.
// The rules: [guides/model-routing.md#markexhausted--late-start-hook-a-driver-whose-session-failed-to-start-on-a-limit-reports-it](../../docs/guides/model-routing.md#markexhausted--late-start-hook-a-driver-whose-session-failed-to-start-on-a-limit-reports-it)
