...
// What it reads, the two pools and the token rules: guides/model-routing.md.
...
// The measurement behind the union: guides/model-routing.md.
...
// Measured 2026-09-06: guides/model-routing.md.
...
// The measurement behind the order: guides/model-routing.md.
  let events = null;
  if (left() > 0) {
