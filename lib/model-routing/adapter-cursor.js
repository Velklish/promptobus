// Cursor availability adapter: binary for auth and inventory, dashboard call for quota.
// What it reads, the two pools and the token rules: [guides/model-routing.md#cursor-adapter-what-the-probe-reads](../../docs/guides/model-routing.md#cursor-adapter-what-the-probe-reads)
...
// Which pool a model is billed to: the bucket list and the per-model events, unioned.
// The measurement behind the union: [guides/model-routing.md#autopoolmodels--the-inventory-ids-the-auto-pool-covers](../../docs/guides/model-routing.md#autopoolmodels--the-inventory-ids-the-auto-pool-covers)
...
// The auto bucket list, and what it lags behind.
// Measured 2026-09-06: [guides/model-routing.md#autotiermodels--the-ids-cursor-billed-to-the-auto-pool-this-cycle-off](../../docs/guides/model-routing.md#autotiermodels--the-ids-cursor-billed-to-the-auto-pool-this-cycle-off)
...
// The pool a model is billed to, asked BEFORE the windows.
// The measurement behind the order: [guides/model-routing.md#events--the-pool-a-model-is-billed-to-is-a-fact-the-harness-states-and-the-bucket](../../docs/guides/model-routing.md#events--the-pool-a-model-is-billed-to-is-a-fact-the-harness-states-and-the-bucket)
  let events = null;
  if (left() > 0) {
