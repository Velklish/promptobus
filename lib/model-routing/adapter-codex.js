// Codex availability adapter: what the logged-in account can do, before any session.
// What it reads and what was measured: [guides/model-routing.md#codex-adapter-what-the-probe-reads](../../docs/guides/model-routing.md#codex-adapter-what-the-probe-reads)
...
// What the probe reads for the limit, and what it refuses to ask the binary.
// The reads and the refusals: [guides/model-routing.md#window_kind_by_id--the-subscription-windows-of-a-snapshot-normalised](../../docs/guides/model-routing.md#window_kind_by_id--the-subscription-windows-of-a-snapshot-normalised)
