 ...
 *
 * Only these enter completion-duration, turn and review-round medians. Throughput
 * is model-output evidence and uses every record that carries a usable observation,
 * including a dismissed run; a run without a result can still report tokens/s.
 */
