// Validation of a catalog file and of an overlay, before either reaches the merge.
// Which findings exist and what each one means: [guides/model-routing.md#validate-what-a-catalog-or-an-overlay-is-refused-for](../../docs/guides/model-routing.md#validate-what-a-catalog-or-an-overlay-is-refused-for)
...
// The overlay findings: what each code means and why an empty intersection is one.
// The list: [guides/model-routing.md#citationchecks--adr-004--catalog-ratings-from-published-results-validate-refuses-a-rated](../../docs/guides/model-routing.md#citationchecks--adr-004--catalog-ratings-from-published-results-validate-refuses-a-rated)
...
// ([[guides/model-routing.md#validate-what-a-catalog-or-an-overlay-is-refused-for](../../docs/guides/model-routing.md#validate-what-a-catalog-or-an-overlay-is-refused-for)](../../docs/guides/model-routing.md)): harness
