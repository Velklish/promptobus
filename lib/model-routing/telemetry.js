 ...
 *
 * A routed participant role with a model on the record. It is `liveTuples`'
 ...
 *
 * A participant is counted when it lifted a session: a routed participant role
 ...
 *
 * Count and size stay separate from summary because the CLI line reports only
 * those two; an unreadable file must not read as "no records yet".
 */
