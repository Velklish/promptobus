...
// состояний надзирателя ЯВНО. Карта живёт отдельным модулем, а не внутри
// driver'а: driver знает свой harness и не обязан знать про соседей.
//
// **Этот файл — единственная дверь механизма к driver'ам**. Остальные
...
//
// Driver'ов в ней трое — Claude Code, Cursor и Codex. Подставные
