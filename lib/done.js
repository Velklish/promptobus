...
export async function done(rootOrHost, opts = {}) {
  ...
  // Кебабный ключ читается своим именем: вызывающий отдаёт сюда весь объект `values`,
  // и перевод на шве тут не нужен.
  ...
  // Привязки, потерявшие живость вместе с задачей. Механизму они не мешают —
